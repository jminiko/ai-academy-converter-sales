...
import { 
  ...
  Battery, Zap as Flash, Sun, Moon, CloudRain,
  Snowflake, Wind, Thermometer, Droplets, Flame,
  Mountain, Trees as Tree, Flower, Leaf, Sprout as Seed,
  Fish, Bird, Rabbit, Cat, Dog,
  Apple, Cherry, Grape, Citrus as Orange,
  Coffee, Wine, Beer, Cake, Pizza,
  Truck, Bus, Bike as Bicycle, Car as Motorcycle, Ship as Boat,
  Rocket, Satellite, Globe2, MapPin, Navigation,
  Clock, Watch, Hourglass, Timer as StopWatch, AlarmClock,
  Book, Newspaper, BookOpen as Magazine, Bookmark, Library,
  Pen, Pencil, Eraser, Paintbrush,
  Gamepad, Dice1 as Dice, Puzzle, Crown as ChessKnight, Spade,
  Shirt, Crown as Hat, Glasses, Footprints as Shoe,
  Laptop, Monitor as Desktop, Tablet, Printer,
