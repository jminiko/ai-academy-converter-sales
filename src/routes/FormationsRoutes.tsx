...
import FormationDeepLearningAvance from "@/pages/formations/DeepLearningAvance";
...
import FormationEdgeAI from "@/pages/formations/EdgeAI";
...
const FormationsRoutes = () => {
  return (
    <>
      ...
      <Route path="/formation-deep-learning-avance" element={<FormationDeepLearningAvance />} />
      ...
      <Route path="/formation-edge-ai" element={<FormationEdgeAI />} />
