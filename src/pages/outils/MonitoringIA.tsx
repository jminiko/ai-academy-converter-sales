      ...
      <section className="py-20 bg-gradient-to-r from-red-600 to-pink-600">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-red-100 mb-8 max-w-3xl mx-auto">
            Surveillance en temps réel de vos modèles IA en production
          </p>
          <Button size="lg" className="bg-white text-red-600 hover:bg-gray-100">
            Surveiller mes modèles
          </Button>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="p-6 text-center">
              ...
              <p className="text-gray-600">Monitoring 24/7</p>
            </Card>
            <Card className="p-6 text-center">
            ...
            <Card className="p-6 text-center">
              ...
              <p className="text-gray-600">Métriques temps réel</p>
            </Card>
            <Card className="p-6 text-center">
              <Activity className="h-12 w-12 text-red-600 mx-auto mb-4" />
              <h3 className="text-xl font-bold mb-2">Santé système</h3>
              <p className="text-gray-600">État des modèles</p>
            </Card>
          </div>
        </div>
      </section>
