        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="p-6 text-center">
              ...
              <h3 className="text-xl font-bold mb-2">Coûts initiaux</h3>
              <p className="text-gray-600">Investissement de départ</p>
            </Card>
            <Card className="p-6 text-center">
              <TrendingUp className="h-12 w-12 text-green-600 mx-auto mb-4" />
              <h3 className="text-xl font-bold mb-2">Gains estimés</h3>
              <p className="text-gray-600">Bénéfices projetés</p>
            </Card>
            <Card className="p-6 text-center">
              <PieChart className="h-12 w-12 text-green-600 mx-auto mb-4" />
              <h3 className="text-xl font-bold mb-2">Analyse détaillée</h3>
            ...
            <Card className="p-6 text-center">
              ...
              <p className="text-gray-600">Scénarios multiples</p>
            </Card>
          </div>
        </div>
      </section>
...
export default CalculatriceROI;
