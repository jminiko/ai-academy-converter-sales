...
import { Settings, Code, CheckCircle, Rocket } from "lucide-react";
      ...
      <section className="py-20 bg-gradient-to-r from-green-600 to-emerald-600">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-green-100 mb-8 max-w-3xl mx-auto">
            Accompagnement technique pour vos projets IA
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="p-6 text-center">
              ...
              <p className="text-gray-600">Solutions sur mesure</p>
            </Card>
            <Card className="p-6 text-center">
              <Settings className="h-12 w-12 text-green-600 mx-auto mb-4" />
              <h3 className="text-xl font-bold mb-2">Configuration</h3>
              <p className="text-gray-600">Paramétrage optimal</p>
            </Card>
            <Card className="p-6 text-center">
              <CheckCircle className="h-12 w-12 text-green-600 mx-auto mb-4" />
              <h3 className="text-xl font-bold mb-2">Tests & validation</h3>
              <p className="text-gray-600">Qualité assurée</p>
            </Card>
            <Card className="p-6 text-center">
