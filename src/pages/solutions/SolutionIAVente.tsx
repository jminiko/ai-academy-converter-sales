        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <Card className="p-6 text-center">
              ...
              <h3 className="text-xl font-bold mb-2">CRM Intelligent</h3>
              <p className="text-gray-600">Gestion client optimisée</p>
            </Card>
            <Card className="p-6 text-center">
              <BarChart className="h-12 w-12 text-blue-600 mx-auto mb-4" />
              <h3 className="text-xl font-bold mb-2">Prédiction</h3>
              <p className="text-gray-600">Prévision des ventes</p>
            </Card>
            <Card className="p-6 text-center">
