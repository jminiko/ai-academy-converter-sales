          ...
          <div className="space-y-8">
            <Card>
              ...
              <CardContent className="prose max-w-none">
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  de 500 000 euros, immatriculée au RCS de Paris sous le numéro 123 456 789, ayant son 
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-gray-700">
                  ...
                  portabilité de ses données. Pour exercer ces droits : contact@twentyonetalents.com
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-gray-700">
                  Pour toute question concernant ces CGV : contact@twentyonetalents.com
                </p>
              </CardContent>
            </Card>
            ...
            <div className="bg-blue-50 p-6 rounded-lg text-center">
              ...
              <p className="text-gray-700">
                ...
                <strong>Email :</strong> contact@twentyonetalents.com<br />
